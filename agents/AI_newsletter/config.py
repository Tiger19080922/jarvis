...
# ── MODELS ────────────────────────────────────────────────────────────────────
FLASH  = "gemini-1.5-flash"   # fast + cheap: scoring, search, subject line, pivot lens
PRO    = "gemini-1.5-flash"   # writing tasks — upgrade to gemini-1.5-pro for higher quality
